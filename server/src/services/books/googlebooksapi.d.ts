...
type Book = {
  ...
  volumeInfo: {
    ...
    allowAnonLoggin: boolean;
    contentVersion: string;
    panelizationSummary: {
      containsEpubBulles: boolean;
